...
import com.elifen.leaf.UIActivity.NewsDetailsActivity;
...
public class NewsFragment extends Fragment {
    ...
    private void initView(View view) {
        recyclerView = (EasyRecyclerView) view.findViewById(R.id.newsRecycleView);
    ...
    private void getData() {
        ...
        apiService.getNewsData("db02826957a59aad6b9e85fbb21831ff", "10", page)
