...
/**
 * Servlet implementation class DeleteMyTopicServlet
 */
@WebServlet(name = "DeleteMyTopicServlet",
  urlPatterns = {"/DeleteMyTopicServlet"})
public class DeleteMyTopicServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean result = topicDatabase.delectMyTopic(t_id);
		String message = "";
		if(result){
