...
/**
 * Servlet implementation class GetMyPrisedServlet
 */
@WebServlet(name = "GetMyPrisedServlet",
urlPatterns ={"/GetMyPrisedServlet"})
public class GetMyPrisedServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String idStr = request.getParameter("currentUserId");
		int currentUserId = Integer.parseInt(idStr);
		postLists = postDatabase.getMyPrised(currentUserId);
		//利用Gson将json转换成字符串
		Gson gson = new Gson();
